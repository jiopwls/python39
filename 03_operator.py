...
# 관계식 : 관계연산자를(대소, 순서관계) 이용한 수식
print(10 > 3, 10 < 3)

# 논리식 : 논리연산자를(논리 합/곱/부정) 이용한 수식
...
print('123' + '456')
print(123 + '456') # int 와 str은 더하기를 못함 - 형 변환 필요
# 문자열을 숫자로 변환 : int(), float()
print(123 + int('456'))

# 숫자형과 문자형의 논리 연산
# 0 또는 빈 문자열은 False로 인식
# bool 함수를 이용하면 지정한 데이터의 논리값을 알 수 있음
print(bool(0), bool(''))
print(bool(1), bool('ㄱ'))

# 다음 수식의 결과는 True인 값이 출력
print(0 and 'abc' ,1 and 'r')
print('' or 'ㄱㄴㄷ' , '' and 'abc')