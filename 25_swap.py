...
print('print swap 호출',x,y, id(x),id(y))
...
print('swap2 호출 전', nums[0], nums[1], id(nums[0]),id(nums[1]))

swap2(nums)

print('swap2 호출 후', nums[0], nums[1], id(nums[0]),id(nums[1]))
...
def swap3():
    ...
    x = y
    y = c
    print('swap3 내부', x, y, id(x), id(y))

x = 3
y = 5
print('swap3 호출전',x,y, id(x),id(y))

swap3()

print('print swap3 호출',x,y, id(x),id(y))